...
public class SmeltingRecipesBranch extends TreeBranch {
	...
	public void addBranch(String branchName, TreeBranch branch) {
		if (branch instanceof SmeltingRecipeBranch) subBranches.put(branchName, branch);
	}
	...
	@Override public GuiCreateBranch getBranchCreationGui(GuiScreen screen) {
		return new GuiCreateBranch(this, "Smelting Recipe", SmeltingRecipeBranch.class, screen);
	}
